...
describe("CurveProps", () => {
  test("can be constructed", () => {
    const props = new CurveProps(spline, {tileWidth: 1, tileHeight: 1, stroke: 1});
    expect(props.props).toHaveProperty("stroke", 1);
  });

  test.skip("computes the lines", () => {
    const props = new CurveProps(spline, {tileWidth: 1, tileHeight: 1, stroke: 1, bezierSplit: true});
